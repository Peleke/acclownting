...
[![CI](https://img.shields.io/github/actions/workflow/status/Peleke/acclownting/ci.yml?branch=main&style=for-the-badge&logo=github&label=CI&event=push)](https://github.com/Peleke/acclownting/actions/workflows/ci.yml)
